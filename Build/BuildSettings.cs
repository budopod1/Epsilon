namespace Epsilon;
public class BuildSettings(string inputPath, string providedOutput, EPSLCACHE cache, CacheMode cacheMode, OptimizationLevel optLevel, OutputType outputType, bool linkBuiltins, bool linkLibraries, bool linkBuiltinModules) {
