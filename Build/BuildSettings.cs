...
public class BuildSettings {
    ...
    public BuildSettings(string inputPath, EPSLPROJ proj, EPSLCACHE cache, CacheMode cacheMode, bool linkBuiltins, bool linkLibraries, IEnumerable<string> extraClangOptions) {
        InputPath = inputPath;
        Proj = proj;
        Cache = cache;
        CacheMode = cacheMode;
